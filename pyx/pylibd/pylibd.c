...
MAKE_CALLBACK(float, (const char *recv, float x), Py_BuildValue, ("(sf)", recv, x))
MAKE_CALLBACK(symbol, (const char *recv, const char *symbol), Py_BuildValue, ("(ss)", recv, symbol))
MAKE_CALLBACK(list, (const char *recv, int n, t_atom *pd_args), convertArgs, (recv, NULL, n, pd_args))
MAKE_CALLBACK(message, (const char *recv, const char *symbol, int n, t_atom *pd_args), convertArgs, (recv, symbol, n, pd_args))
MAKE_CALLBACK(noteon, (int channel, int pitch, int velocity), Py_BuildValue, ("(iii)", channel, pitch, velocity))
MAKE_CALLBACK(controlchange, (int channel, int controller, int velocity), Py_BuildValue, ("(iii)", channel, controller, velocity))
MAKE_CALLBACK(programchange, (int channel, int value), Py_BuildValue, ("(ii)", channel, value))
MAKE_CALLBACK(pitchbend, (int channel, int value), Py_BuildValue, ("(ii)", channel, value))
MAKE_CALLBACK(aftertouch, (int channel, int velocity), Py_BuildValue, ("(ii)", channel, velocity))
MAKE_CALLBACK(polyaftertouch, (int channel, int pitch, int velocity), Py_BuildValue, ("(iii)", channel, pitch, velocity))
MAKE_CALLBACK(midibyte, (int port, int byte), Py_BuildValue, ("(ii)", port, byte))
